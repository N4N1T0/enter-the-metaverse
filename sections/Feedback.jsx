    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-mormal sm:text-[18px] text-[12px]sm:leading-[22px] leading-[16px] text-white" >Founder of Metaverse</p>
        </div>
        <p className="mt-[24px] font-mormal sm:text-[24px] text-[18px]sm:leading-[45px] leading-[39px] text-white">
